...
class AdventureQuiz {
    ...
    initializeMap() {
        ...
        mapGrid.innerHTML = this.quizState.stages.map(stage => `
            <div class="stage-button ${stage.completed ? 'completed' : ''} ${!stage.unlocked ? 'locked' : ''}" 
                 onclick="${stage.unlocked ? `app.navigateToStage(${stage.id})` : ''}">
